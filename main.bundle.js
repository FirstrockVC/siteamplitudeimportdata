...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__uploadFile_service__ = __webpack_require__("../../../../../src/app/components/uploadFile/uploadFile.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csvtojson__ = __webpack_require__("../../../../csvtojson/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csvtojson___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_csvtojson__);
...
var UploadFileComponent = (function () {
    function UploadFileComponent(uploadFileService) {
        ...
        this.uploadFile = function (events, lower, upper) {
            return _this.uploadFileService.uploadAmplitudeData(__WEBPACK_IMPORTED_MODULE_4_lodash__["slice"](events, lower, upper), _this.uploadForm.controls['key'].value);
        };
    }
    UploadFileComponent.prototype.ngOnInit = function () {
        this.uploadForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* FormGroup */]({
            key: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required)
        });
    };
    UploadFileComponent.prototype.onFileChange = function (event) {
        this.file = event.target.files[0];
    };
    UploadFileComponent.prototype.onValidate = function (isValid) {
        var _this = this;
        this.submitted = true;
        if (isValid && (this.data !== '' && this.file !== null)) {
            ...
            reader_1.onload = function () {
                ...
                __WEBPACK_IMPORTED_MODULE_3_csvtojson__({
                    noheader: false,
                    ...
                    if (events_1.length > 0) {
                        var promises = [];
                        for (var i = 0; i < events_1.length; i = i + 1000) {
                            promises.push(_this.uploadFile(events_1, i, +i + 1000));
                        }
...
UploadFileComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_2__uploadFile_service__["a" /* UploadFileService */]],
        template: __webpack_require__("../../../../../src/app/components/uploadFile/uploadFile.template.html")
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__uploadFile_service__["a" /* UploadFileService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__uploadFile_service__["a" /* UploadFileService */]) === "function" && _a || Object])
], UploadFileComponent);
...
var UploadFileService = (function () {
    ...
    UploadFileService.prototype.uploadAmplitudeData = function (events, key) {
        var _this = this;
        var dataString = 'api_key=' + key + '&event=' + JSON.stringify(events);
        ...
        return new Promise(function (resolve, reject) {
            _this.http.request("" + __WEBPACK_IMPORTED_MODULE_2__utils_config__["a" /* Config */].API, options).toPromise()
                .then(function (res) {
                resolve(res);
            }, function (msg) {
                reject(msg);
...
module.exports = "<div class=\"row marketing\">\n    <div class=\"col-lg-12\">\n        <div class=\"col-lg-12\">\n            <div class=\"bd-example\">\n              <form [formGroup]=\"uploadForm\">\n                  <div class=\"form-group row\">\n                      <label class=\"col-sm-2 col-form-label\">Project Key</label>\n                      <div class=\"col-sm-10\">\n                          <input type=\"text\" class=\"form-control\" formControlName=\"key\">\n                          <div [hidden]=\"uploadForm.controls.key.valid || (uploadForm.controls.key.pristine && !submitted)\">\n                              <label class=\"text-danger\">This field is required.</label>\n                          </div>\n                      </div>\n                    </div>\n                    <div class=\"form-group row\">\n                        <label class=\"col-sm-2 col-form-label\">File (.csv)</label>\n                        <div class=\"col-sm-10\">\n                            <div class=\"input-group input-file\" name=\"Fichier1\">\n                                <input [ngModelOptions]=\"{standalone: true}\" type=\"file\" class=\"form-control\" [(ngModel)]=\"data\" (change)=\"onFileChange($event)\" placeholder='Choose a file...' />\n                                <span class=\"input-group-btn\">\n                                      <button class=\"btn btn-warning btn-reset\" (click)=\"resetFile()\" type=\"button\">Reset</button>\n                                </span>\n                            </div>\n                            <div *ngIf=\"(!file && submitted)\">\n                                <label class=\"text-danger\">This file is required.</label>\n                            </div>\n                        </div>\n                      </div>\n                  <div class=\"form-group\">\n                      <button type=\"submit\" (click)=\"onValidate(uploadForm.valid)\" style=\"width: 100%;\" class=\"btn btn-primary\">Submit</button>\n                  </div>\n              </form>\n            </div>\n          </div>\n    </div>\n  </div>\n"
